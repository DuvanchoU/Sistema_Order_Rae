<x-app-layout>
    ...
    <div class="overflow-x-auto">
        <div class="mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Tabla de ventas -->
            <div>
                <table id="ventas" class="w-full text-base border text-center text-gray-500 dark:text-gray-700">
